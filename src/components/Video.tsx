            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img
                                ...
                                alt=""
                                src="https://github.com/marcelorsdd.png"
                            />
                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Marcelo Silva</strong>
                                <span className="text-gray-200 text-sm block">CTO @ Rocketseet</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <a
                            href=""
                            className="p-4 text-sm border-blue-500 text-blue-500 border flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-blue-500 hover:text-gray-900 transition-colors">
                            <Lightning size={24} />
                            Acesse o desafio
                        </a>
                    </div>
